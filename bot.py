...
def hub_keyboard(user_id: int) -> InlineKeyboardMarkup:
    """Main menu: Balance | Top Up · Buy CCs | Cart · Profile · Bases · Admin (admins only)."""
    rows: list[list[InlineKeyboardButton]] = [
        ...
        [
            InlineKeyboardButton(
                "📣 Channel",
                url=PLUXO_CHANNEL_URL,
            )
        ],
    ]
    if is_admin(user_id):
        rows.append(
            [InlineKeyboardButton("🔧 Admin panel", callback_data="m_admin")]
        )
...
async def on_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if data == "adm_port_home":
        ...
        await query.message.reply_text(
            ...
            reply_markup=hub_keyboard(user.id),
            parse_mode="HTML",
        )
        return
