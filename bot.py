...
def admin_portal_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("🗄️ BIN notebook", callback_data="adm_port_bin")],
            [
                InlineKeyboardButton(
...
async def handle_main_reply_menu(
    ...
    if text in (BTN_REPLY_BUY, BTN_REPLY_ORDERS):
        await msg.reply_text(
            "💳 <b>Shop with which balance?</b>\n\n"
            "<b>JR Bucks</b> — GetToTheMoneyJR stock.\n"
            "<b>Tony Bucks</b> — TONY BASE stock.\n\n"
            "Pick a wallet below.",
